...
class KnapsackDynamicProgramming {
	...
	private static int[] printSelectedElements(int dp[][], int[] weights, int[] profits, int capacity){
	...
	public static void main(String[] args) {
		...
		try {
			...
			try {
				...
				int[] used = printSelectedElements(dpMain, weights, profits, w);
